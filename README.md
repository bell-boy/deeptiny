...
1. Remove support for higher order differentiation.
2. Add Abstract Module base class.
3. Add Docker testing environment for CI/CD.
4. Finish Transformer inference demo.
