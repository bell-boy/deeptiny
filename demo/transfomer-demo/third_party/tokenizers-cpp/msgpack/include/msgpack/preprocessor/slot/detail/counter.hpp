...
#define MSGPACK_PP_COUNTER                                                       \
  MSGPACK_PP_SLOT_CC_10(MSGPACK_PP_COUNTER_DIGIT_10, MSGPACK_PP_COUNTER_DIGIT_9, \
                        MSGPACK_PP_COUNTER_DIGIT_8, MSGPACK_PP_COUNTER_DIGIT_7,  \
                        MSGPACK_PP_COUNTER_DIGIT_6, MSGPACK_PP_COUNTER_DIGIT_5,  \
                        MSGPACK_PP_COUNTER_DIGIT_4, MSGPACK_PP_COUNTER_DIGIT_3,  \
                        MSGPACK_PP_COUNTER_DIGIT_2, MSGPACK_PP_COUNTER_DIGIT_1)
#elif MSGPACK_PP_COUNTER_DIGIT_9
#define MSGPACK_PP_COUNTER                                                                \
  MSGPACK_PP_SLOT_CC_9(                                                                   \
      MSGPACK_PP_COUNTER_DIGIT_9, MSGPACK_PP_COUNTER_DIGIT_8, MSGPACK_PP_COUNTER_DIGIT_7, \
      MSGPACK_PP_COUNTER_DIGIT_6, MSGPACK_PP_COUNTER_DIGIT_5, MSGPACK_PP_COUNTER_DIGIT_4, \
      MSGPACK_PP_COUNTER_DIGIT_3, MSGPACK_PP_COUNTER_DIGIT_2, MSGPACK_PP_COUNTER_DIGIT_1)
#elif MSGPACK_PP_COUNTER_DIGIT_8
#define MSGPACK_PP_COUNTER                                                     \
  MSGPACK_PP_SLOT_CC_8(MSGPACK_PP_COUNTER_DIGIT_8, MSGPACK_PP_COUNTER_DIGIT_7, \
                       MSGPACK_PP_COUNTER_DIGIT_6, MSGPACK_PP_COUNTER_DIGIT_5, \
                       MSGPACK_PP_COUNTER_DIGIT_4, MSGPACK_PP_COUNTER_DIGIT_3, \
                       MSGPACK_PP_COUNTER_DIGIT_2, MSGPACK_PP_COUNTER_DIGIT_1)
#elif MSGPACK_PP_COUNTER_DIGIT_7
#define MSGPACK_PP_COUNTER                                                     \
  MSGPACK_PP_SLOT_CC_7(MSGPACK_PP_COUNTER_DIGIT_7, MSGPACK_PP_COUNTER_DIGIT_6, \
                       MSGPACK_PP_COUNTER_DIGIT_5, MSGPACK_PP_COUNTER_DIGIT_4, \
                       MSGPACK_PP_COUNTER_DIGIT_3, MSGPACK_PP_COUNTER_DIGIT_2, \
                       MSGPACK_PP_COUNTER_DIGIT_1)
#elif MSGPACK_PP_COUNTER_DIGIT_6
#define MSGPACK_PP_COUNTER                                                     \
  MSGPACK_PP_SLOT_CC_6(MSGPACK_PP_COUNTER_DIGIT_6, MSGPACK_PP_COUNTER_DIGIT_5, \
                       MSGPACK_PP_COUNTER_DIGIT_4, MSGPACK_PP_COUNTER_DIGIT_3, \
                       MSGPACK_PP_COUNTER_DIGIT_2, MSGPACK_PP_COUNTER_DIGIT_1)
#elif MSGPACK_PP_COUNTER_DIGIT_5
#define MSGPACK_PP_COUNTER                                                     \
  MSGPACK_PP_SLOT_CC_5(MSGPACK_PP_COUNTER_DIGIT_5, MSGPACK_PP_COUNTER_DIGIT_4, \
                       MSGPACK_PP_COUNTER_DIGIT_3, MSGPACK_PP_COUNTER_DIGIT_2, \
                       MSGPACK_PP_COUNTER_DIGIT_1)
#elif MSGPACK_PP_COUNTER_DIGIT_4
#define MSGPACK_PP_COUNTER                                                     \
  MSGPACK_PP_SLOT_CC_4(MSGPACK_PP_COUNTER_DIGIT_4, MSGPACK_PP_COUNTER_DIGIT_3, \
                       MSGPACK_PP_COUNTER_DIGIT_2, MSGPACK_PP_COUNTER_DIGIT_1)
#elif MSGPACK_PP_COUNTER_DIGIT_3
#define MSGPACK_PP_COUNTER                                                     \
  MSGPACK_PP_SLOT_CC_3(MSGPACK_PP_COUNTER_DIGIT_3, MSGPACK_PP_COUNTER_DIGIT_2, \
                       MSGPACK_PP_COUNTER_DIGIT_1)
