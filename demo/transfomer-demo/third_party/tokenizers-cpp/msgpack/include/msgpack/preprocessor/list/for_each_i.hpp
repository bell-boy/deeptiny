...
#define MSGPACK_PP_LIST_FOR_EACH_I(macro, data, list)                  \
  MSGPACK_PP_FOR((macro, data, list, 0), MSGPACK_PP_LIST_FOR_EACH_I_P, \
                 MSGPACK_PP_LIST_FOR_EACH_I_O, MSGPACK_PP_LIST_FOR_EACH_I_M)
#else
#define MSGPACK_PP_LIST_FOR_EACH_I(macro, data, list) \
...
#define MSGPACK_PP_LIST_FOR_EACH_I_O(r, x)                         \
  (MSGPACK_PP_TUPLE_ELEM(4, 0, x), MSGPACK_PP_TUPLE_ELEM(4, 1, x), \
...
#define MSGPACK_PP_LIST_FOR_EACH_I_M(r, x)                                                       \
  MSGPACK_PP_LIST_FOR_EACH_I_M_D(r, MSGPACK_PP_TUPLE_ELEM(4, 0, x),                              \
                                 MSGPACK_PP_TUPLE_ELEM(4, 1, x), MSGPACK_PP_TUPLE_ELEM(4, 2, x), \
...
#define MSGPACK_PP_LIST_FOR_EACH_I_R(r, macro, data, list)                 \
  MSGPACK_PP_FOR_##r((macro, data, list, 0), MSGPACK_PP_LIST_FOR_EACH_I_P, \
                     MSGPACK_PP_LIST_FOR_EACH_I_O, MSGPACK_PP_LIST_FOR_EACH_I_M)
#else
#define MSGPACK_PP_LIST_FOR_EACH_I_R(r, macro, data, list) \
