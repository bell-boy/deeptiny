...
#else
#define MSGPACK_PP_SEQ_TRANSFORM_O(s, state, elem)                    \
  MSGPACK_PP_SEQ_TRANSFORM_O_I(s, MSGPACK_PP_TUPLE_ELEM(3, 0, state), \
                               MSGPACK_PP_TUPLE_ELEM(3, 1, state),    \
                               MSGPACK_PP_TUPLE_ELEM(3, 2, state), elem)
#endif
#
...
#define MSGPACK_PP_SEQ_TRANSFORM_S(s, op, data, seq) \
  MSGPACK_PP_SEQ_TAIL(MSGPACK_PP_TUPLE_ELEM(         \
      3, 2, MSGPACK_PP_SEQ_FOLD_LEFT_##s(MSGPACK_PP_SEQ_TRANSFORM_O, (op, data, (nil)), seq)))
#else
