...
#define MSGPACK_PP_LIST_CAT(list)                                               \
  MSGPACK_PP_LIST_FOLD_LEFT(MSGPACK_PP_LIST_CAT_O, MSGPACK_PP_LIST_FIRST(list), \
...
#define MSGPACK_PP_LIST_CAT_D(d, list)                                              \
  MSGPACK_PP_LIST_FOLD_LEFT_##d(MSGPACK_PP_LIST_CAT_O, MSGPACK_PP_LIST_FIRST(list), \
                                MSGPACK_PP_LIST_REST(list))
#else
