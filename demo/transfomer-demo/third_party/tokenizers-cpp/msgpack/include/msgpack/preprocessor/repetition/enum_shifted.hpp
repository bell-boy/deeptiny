...
#else
#define MSGPACK_PP_ENUM_SHIFTED_M_1(z, n, md)                          \
  MSGPACK_PP_ENUM_SHIFTED_M_1_I(z, n, MSGPACK_PP_TUPLE_ELEM(2, 0, md), \
                                MSGPACK_PP_TUPLE_ELEM(2, 1, md))
#define MSGPACK_PP_ENUM_SHIFTED_M_2(z, n, md)                          \
  MSGPACK_PP_ENUM_SHIFTED_M_2_I(z, n, MSGPACK_PP_TUPLE_ELEM(2, 0, md), \
                                MSGPACK_PP_TUPLE_ELEM(2, 1, md))
#define MSGPACK_PP_ENUM_SHIFTED_M_3(z, n, md)                          \
  MSGPACK_PP_ENUM_SHIFTED_M_3_I(z, n, MSGPACK_PP_TUPLE_ELEM(2, 0, md), \
                                MSGPACK_PP_TUPLE_ELEM(2, 1, md))
#endif
#
