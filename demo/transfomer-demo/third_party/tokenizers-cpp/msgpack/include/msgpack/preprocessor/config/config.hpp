...
#if defined __GCCXML__ || defined __PATHSCALE__ || defined __DMC__ || defined __CODEGEARC__ ||     \
    defined __BORLANDC__ || defined __MWERKS__ || (defined __SUNPRO_CC && __SUNPRO_CC < 0x5120) || \
    defined __HP_aCC && !defined __EDG__ || defined __MRC__ || defined __SC__ || defined __PGI
...
#define MSGPACK_PP_VARIADICS 1
    ...
    (defined(__INTELLISENSE__) || (defined(__INTEL_COMPILER) && __INTEL_COMPILER >= 1700) ||     \
     !(defined __EDG__ || defined __GCCXML__ || defined __CUDACC__ || defined __PATHSCALE__ ||   \
       defined __DMC__ || defined __CODEGEARC__ || defined __BORLANDC__ || defined __MWERKS__ || \
