...
#define MSGPACK_PP_ARRAY_REMOVE_D(d, array, i)                                                     \
  MSGPACK_PP_TUPLE_ELEM(4, 2,                                                                      \
                        MSGPACK_PP_WHILE_##d(MSGPACK_PP_ARRAY_REMOVE_P, MSGPACK_PP_ARRAY_REMOVE_O, \
                                             (0, i, (0, ()), array)))
#else
...
#define MSGPACK_PP_ARRAY_REMOVE_O(d, st)                                                        \
  MSGPACK_PP_ARRAY_REMOVE_O_I(MSGPACK_PP_TUPLE_ELEM(4, 0, st), MSGPACK_PP_TUPLE_ELEM(4, 1, st), \
                              MSGPACK_PP_TUPLE_ELEM(4, 2, st), MSGPACK_PP_TUPLE_ELEM(4, 3, st))
#endif
#
#if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_DMC()
#define MSGPACK_PP_ARRAY_REMOVE_O_I(n, i, res, arr)                                \
  (MSGPACK_PP_INC(n), i,                                                           \
   MSGPACK_PP_IIF(MSGPACK_PP_NOT_EQUAL(n, i), MSGPACK_PP_ARRAY_PUSH_BACK,          \
