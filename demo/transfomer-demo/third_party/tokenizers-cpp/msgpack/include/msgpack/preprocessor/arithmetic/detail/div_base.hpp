...
#define MSGPACK_PP_DIV_BASE_P(d, rxy)                                                            \
  MSGPACK_PP_DIV_BASE_P_I(d, MSGPACK_PP_TUPLE_ELEM(3, 0, rxy), MSGPACK_PP_TUPLE_ELEM(3, 1, rxy), \
...
#define MSGPACK_PP_DIV_BASE_O(d, rxy)                                                            \
  MSGPACK_PP_DIV_BASE_O_I(d, MSGPACK_PP_TUPLE_ELEM(3, 0, rxy), MSGPACK_PP_TUPLE_ELEM(3, 1, rxy), \
                          MSGPACK_PP_TUPLE_ELEM(3, 2, rxy))
#endif
#
