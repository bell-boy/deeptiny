...
#define MSGPACK_PP_SEQ_CAT(seq)                                                 \
  MSGPACK_PP_IF(MSGPACK_PP_DEC(MSGPACK_PP_SEQ_SIZE(seq)), MSGPACK_PP_SEQ_CAT_I, \
...
#define MSGPACK_PP_SEQ_CAT_S(s, seq)                                                \
  MSGPACK_PP_IF(MSGPACK_PP_DEC(MSGPACK_PP_SEQ_SIZE(seq)), MSGPACK_PP_SEQ_CAT_S_I_A, \
                MSGPACK_PP_SEQ_CAT_S_I_B)(s, seq) /**/
#define MSGPACK_PP_SEQ_CAT_S_I_A(s, seq)                                       \
  MSGPACK_PP_SEQ_FOLD_LEFT_##s(MSGPACK_PP_SEQ_CAT_O, MSGPACK_PP_SEQ_HEAD(seq), \
                               MSGPACK_PP_SEQ_TAIL(seq))
