...
#define MSGPACK_PP_LIST_FIRST_N(count, list)                                                       \
  MSGPACK_PP_LIST_REVERSE(                                                                         \
      MSGPACK_PP_TUPLE_ELEM(3, 2,                                                                  \
                            MSGPACK_PP_WHILE(MSGPACK_PP_LIST_FIRST_N_P, MSGPACK_PP_LIST_FIRST_N_O, \
...
#define MSGPACK_PP_LIST_FIRST_N_D(d, count, list)                                       \
  MSGPACK_PP_LIST_REVERSE_D(                                                            \
      d, MSGPACK_PP_TUPLE_ELEM(                                                         \
             3, 2,                                                                      \
             MSGPACK_PP_WHILE_##d(MSGPACK_PP_LIST_FIRST_N_P, MSGPACK_PP_LIST_FIRST_N_O, \
                                  (count, list, MSGPACK_PP_NIL))))
#else
