...
#define MSGPACK_OS_BSD_FREE MSGPACK_VERSION_NUMBER(4, 10, 0)
#elif __FreeBSD_version == 492000
#define MSGPACK_OS_BSD_FREE MSGPACK_VERSION_NUMBER(4, 11, 0)
#elif __FreeBSD_version < 500000
#define MSGPACK_OS_BSD_FREE MSGPACK_PREDEF_MAKE_10_VRPPPP(__FreeBSD_version)
#else
#define MSGPACK_OS_BSD_FREE MSGPACK_PREDEF_MAKE_10_VVRRPPP(__FreeBSD_version)
#endif
#else
