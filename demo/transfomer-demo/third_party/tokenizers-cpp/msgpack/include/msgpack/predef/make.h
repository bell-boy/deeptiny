...
#define MSGPACK_PREDEF_MAKE_10_VRPPPP(V) \
  MSGPACK_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 10000) % 10, (V) % 10000)
...
#define MSGPACK_PREDEF_MAKE_10_VVRRP(V) \
  MSGPACK_VERSION_NUMBER(((V) / 1000) % 100, ((V) / 10) % 100, (V) % 10)
...
#define MSGPACK_PREDEF_MAKE_10_VVRRPPP(V) \
  MSGPACK_VERSION_NUMBER(((V) / 100000) % 100, ((V) / 1000) % 100, (V) % 1000)
