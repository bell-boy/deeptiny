...
MSGPACK_API_VERSION_NAMESPACE(v1) {
  ...
  class tuple : public std::tuple<Types...> {
   public:
    ...
    typename tuple_element<I, base>::type& get() & noexcept {
      return std::get<I>(static_cast<base&>(*this));
    }

    template <std::size_t I>
    typename tuple_element<I, base>::type const& get() const& noexcept {
  ...
  auto tuple_cat(Tuples&&... args) -> decltype(std::tuple_cat(
