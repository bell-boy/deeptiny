...
MSGPACK_API_VERSION_NAMESPACE(v3) {
  ...
  msgpack::object_handle unpack(
      ...
      msgpack::unpack_reference_func f = MSGPACK_NULLPTR, void* user_data = MSGPACK_NULLPTR,
   ...
   *
   */
  msgpack::object_handle unpack(const char* data, std::size_t len, bool& referenced,
                                msgpack::unpack_reference_func f = MSGPACK_NULLPTR,
                                void* user_data = MSGPACK_NULLPTR,
                                msgpack::unpack_limit const& limit = unpack_limit());
   ...
   */
  msgpack::object_handle unpack(
      const char* data, std::size_t len, msgpack::unpack_reference_func f = MSGPACK_NULLPTR,
      void* user_data = MSGPACK_NULLPTR, msgpack::unpack_limit const& limit = unpack_limit());
   ...
   *
   */
  void unpack(msgpack::object_handle & result, const char* data, std::size_t len, std::size_t& off,
              bool& referenced, msgpack::unpack_reference_func f = MSGPACK_NULLPTR,
              void* user_data = MSGPACK_NULLPTR,
              msgpack::unpack_limit const& limit = unpack_limit());
   ...
   *
   */
  void unpack(msgpack::object_handle & result, const char* data, std::size_t len, bool& referenced,
              msgpack::unpack_reference_func f = MSGPACK_NULLPTR, void* user_data = MSGPACK_NULLPTR,
              msgpack::unpack_limit const& limit = unpack_limit());
   ...
   *
   */
  void unpack(msgpack::object_handle & result, const char* data, std::size_t len,
              msgpack::unpack_reference_func f = MSGPACK_NULLPTR, void* user_data = MSGPACK_NULLPTR,
              msgpack::unpack_limit const& limit = unpack_limit());
