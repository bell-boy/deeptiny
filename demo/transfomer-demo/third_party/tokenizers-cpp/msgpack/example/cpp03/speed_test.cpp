...
// g++ -std=c++11 -O3 -g -Ipath_to_msgpack_src -Ipath_to_boost speed_test.cc -Lpath_to_boost_lib
// -lboost_timer -lboost_system export LD_LIBRARY_PATH=path_to_boost_lib
...
void test_map_pack_unpack() {
  ...
  std::cout << "Start unpacking...by void unpack(object_handle& oh, const char* data, size_t len)"
            << std::endl;
  {
    boost::timer::cpu_timer timer;
...
int main(void) { test_map_pack_unpack(); }
