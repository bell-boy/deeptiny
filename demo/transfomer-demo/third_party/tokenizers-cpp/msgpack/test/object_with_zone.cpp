...
BOOST_AUTO_TEST_CASE(vector) {
  for (unsigned int k = 0; k < kLoop; k++) {
    std::vector<int> v1;
    v1.push_back(1);
    for (unsigned int i = 1; i < kElements; i++) v1.push_back(static_cast<int>(i));
    msgpack::zone z;
...
BOOST_AUTO_TEST_CASE(vector_char) {
  for (unsigned int k = 0; k < kLoop; k++) {
    std::vector<char> v1;
    v1.push_back(1);
    for (unsigned int i = 1; i < kElements; i++) v1.push_back(static_cast<char>(i));
    msgpack::zone z;
    msgpack::object obj(v1, z);
...
BOOST_AUTO_TEST_CASE(vector_unsigned_char) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    ...
    v1.push_back(1);
    for (unsigned int i = 1; i < kElements; i++) v1.push_back(static_cast<unsigned char>(i));
    msgpack::zone z;
    msgpack::object obj(v1, z);
...
BOOST_AUTO_TEST_CASE(set) {
  for (unsigned int k = 0; k < kLoop; k++) {
    std::set<int> v1;
    for (unsigned int i = 0; i < kElements; i++) v1.insert(static_cast<int>(i));
    msgpack::zone z;
    msgpack::object obj(v1, z);
...
BOOST_AUTO_TEST_CASE(multiset) {
  for (unsigned int k = 0; k < kLoop; k++) {
    std::multiset<int> v1;
    for (unsigned int i = 0; i < kElements; i++) v1.insert(i % (kElements / 2));
    msgpack::zone z;
    msgpack::object obj(v1, z);
...
BOOST_AUTO_TEST_CASE(map) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    test_t v1;
    for (unsigned int i = 0; i < kElements; i++) v1.insert(std::make_pair(i, i * 2));
    msgpack::zone z;
    msgpack::object obj(v1, z);
...
BOOST_AUTO_TEST_CASE(tr1_unordered_map) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    test_t v1;
    for (unsigned int i = 0; i < kElements; i++) v1[rand()] = rand();
    msgpack::zone z;
    msgpack::object obj(v1, z);
...
BOOST_AUTO_TEST_CASE(tr1_unordered_set) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    test_t v1;
    for (unsigned int i = 0; i < kElements; i++) v1.insert(rand());
    msgpack::zone z;
    msgpack::object obj(v1, z);
    test_t v2 = obj.as<test_t>();
    BOOST_CHECK_EQUAL(v1.size(), v2.size());
    std::tr1::unordered_set<int>::const_iterator it;
    for (it = v1.begin(); it != v1.end(); ++it) BOOST_CHECK(v2.find(*it) != v2.end());
  }
}
...
BOOST_AUTO_TEST_CASE(tr1_unordered_multiset) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    ...
    for (it = v1.begin(); it != v1.end(); ++it) vec1.push_back(*it);
    for (it = v2.begin(); it != v2.end(); ++it) vec2.push_back(*it);
    BOOST_CHECK_EQUAL(v1.size(), v2.size());
    BOOST_CHECK_EQUAL(vec1.size(), vec2.size());
    std::sort(vec1.begin(), vec1.end());
    std::sort(vec2.begin(), vec2.end());
...
#endif  // defined(__GNUC__) && (__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 7)) &&
        // !defined(__clang__)
...
BOOST_AUTO_TEST_CASE(array) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    test_t v1;
    v1[0] = 1;
    for (unsigned int i = 1; i < kElements; i++) v1[i] = rand();
    msgpack::zone z;
    msgpack::object obj(v1, z);
    BOOST_CHECK(obj.as<test_t>() == v1);
    v1.front() = 42;
...
BOOST_AUTO_TEST_CASE(array_char) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    test_t v1;
    v1[0] = 1;
    for (unsigned int i = 1; i < kElements; i++) v1[i] = static_cast<char>(rand());
    msgpack::zone z;
    msgpack::object obj(v1, z);
    BOOST_CHECK(obj.as<test_t>() == v1);
    v1.front() = 42;
...
BOOST_AUTO_TEST_CASE(array_unsigned_char) {
  ...
  for (unsigned int k = 0; k < kLoop; k++) {
    test_t v1;
    v1[0] = 1;
    for (unsigned int i = 1; i < kElements; i++) v1[i] = static_cast<unsigned char>(rand());
    msgpack::zone z;
    msgpack::object obj(v1, z);
    BOOST_CHECK(obj.as<test_t>() == v1);
    v1.front() = 42;
...
BOOST_AUTO_TEST_CASE(forward_list) {
  for (unsigned int k = 0; k < kLoop; k++) {
    ...
    for (unsigned int i = 0; i < kElements; i++) v1.push_front(static_cast<int>(i));
    msgpack::zone z;
    msgpack::object obj(v1, z);
