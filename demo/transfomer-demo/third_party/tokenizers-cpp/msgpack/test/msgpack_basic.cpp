...
#define GEN_TEST(test_type)                                                               \
  do {                                                                                    \
    ...
    for (unsigned int i = 0; i < kLoop; i++) v.push_back(static_cast<test_type>(rand())); \
...
BOOST_AUTO_TEST_CASE(simple_buffer_char) { GEN_TEST(char); }

BOOST_AUTO_TEST_CASE(simple_buffer_signed_char) { GEN_TEST(signed char); }

BOOST_AUTO_TEST_CASE(simple_buffer_unsigned_char) { GEN_TEST(unsigned char); }

BOOST_AUTO_TEST_CASE(simple_buffer_short) { GEN_TEST(short); }

BOOST_AUTO_TEST_CASE(simple_buffer_int) { GEN_TEST(int); }

BOOST_AUTO_TEST_CASE(simple_buffer_long) { GEN_TEST(long); }

BOOST_AUTO_TEST_CASE(simple_buffer_long_long) { GEN_TEST(long long); }

BOOST_AUTO_TEST_CASE(simple_buffer_unsigned_short) { GEN_TEST(unsigned short); }

BOOST_AUTO_TEST_CASE(simple_buffer_unsigned_int) { GEN_TEST(unsigned int); }

BOOST_AUTO_TEST_CASE(simple_buffer_unsigned_long) { GEN_TEST(unsigned long); }

BOOST_AUTO_TEST_CASE(simple_buffer_unsigned_long_long) { GEN_TEST(unsigned long long); }

BOOST_AUTO_TEST_CASE(simple_buffer_uint8) { GEN_TEST(uint8_t); }

BOOST_AUTO_TEST_CASE(simple_buffer_uint16) { GEN_TEST(uint16_t); }

BOOST_AUTO_TEST_CASE(simple_buffer_uint32) { GEN_TEST(uint32_t); }

BOOST_AUTO_TEST_CASE(simple_buffer_uint64) { GEN_TEST(uint64_t); }

BOOST_AUTO_TEST_CASE(simple_buffer_int8) { GEN_TEST(int8_t); }

BOOST_AUTO_TEST_CASE(simple_buffer_int16) { GEN_TEST(int16_t); }

BOOST_AUTO_TEST_CASE(simple_buffer_int32) { GEN_TEST(int32_t); }

BOOST_AUTO_TEST_CASE(simple_buffer_int64) { GEN_TEST(int64_t); }
...
typedef boost::mpl::list<TypePair<float, signed long long>, TypePair<float, unsigned long long>,
                         TypePair<double, signed long long>, TypePair<double, unsigned long long> >
...
BOOST_AUTO_TEST_CASE(simple_buffer_string) {
  for (unsigned int k = 0; k < kLoop; k++) {
    string val1;
    for (unsigned int i = 0; i < kElements; i++) val1 += static_cast<char>('a' + rand() % 26);
    msgpack::sbuffer sbuf;
    msgpack::pack(sbuf, val1);
    msgpack::object_handle oh = msgpack::unpack(sbuf.data(), sbuf.size());
