...
inline bool operator==(no_def_con1 const& lhs, no_def_con1 const& rhs) { return lhs.i == rhs.i; }

inline bool operator!=(no_def_con1 const& lhs, no_def_con1 const& rhs) { return !(lhs == rhs); }
...
inline bool operator==(no_def_con2 const& lhs, no_def_con2 const& rhs) { return lhs.i == rhs.i; }

inline bool operator!=(no_def_con2 const& lhs, no_def_con2 const& rhs) { return !(lhs == rhs); }
...
struct mystruct_no_def_con {
  ...
  mystruct_no_def_con(no_def_con1 i, no_def_con2 j, no_def_con1 k)
      : f1(std::move(i)), f2(std::move(j)), f3(std::move(k)) {}
...
inline bool operator==(mystruct_no_def_con_def_con const& lhs,
                       mystruct_no_def_con_def_con const& rhs) {
  return lhs.f1 == rhs.f1 && lhs.f2 == rhs.f2 && lhs.f3 == rhs.f3;
}
