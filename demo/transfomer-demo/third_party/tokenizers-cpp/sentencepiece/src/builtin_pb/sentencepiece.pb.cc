...
extern PROTOBUF_INTERNAL_EXPORT_sentencepiece_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
    scc_info_SentencePieceText_sentencepiece_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_sentencepiece_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
...
class SentencePieceText_SentencePieceDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SentencePieceText_SentencePiece>
      _instance;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_SentencePieceText_sentencepiece_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0,
     InitDefaultsscc_info_SentencePieceText_sentencepiece_2eproto},
    {
...
SentencePieceText_SentencePiece::SentencePieceText_SentencePiece(
  ...
  ::memcpy(&id_, &from.id_,
           static_cast<size_t>(reinterpret_cast<char*>(&end_) - reinterpret_cast<char*>(&id_)) +
               sizeof(end_));
...
void SentencePieceText_SentencePiece::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) +
               static_cast<size_t>(reinterpret_cast<char*>(&id_) - reinterpret_cast<char*>(this)),
           0,
           static_cast<size_t>(reinterpret_cast<char*>(&end_) - reinterpret_cast<char*>(&id_)) +
               sizeof(end_));
}
...
void SentencePieceText_SentencePiece::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
size_t SentencePieceText_SentencePiece::ByteSizeLong() const {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      total_size +=
          1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32Size(this->_internal_id());
    }
    ...
    if (cached_has_bits & 0x00000010u) {
      total_size +=
          1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32Size(this->_internal_end());
    }
  }
  if (PROTOBUF_PREDICT_FALSE(_internal_metadata_.have_unknown_fields())) {
    total_size +=
...
void SentencePieceText_SentencePiece::CheckTypeAndMergeFrom(
  ...
  MergeFrom(
      *::PROTOBUF_NAMESPACE_ID::internal::DownCast<const SentencePieceText_SentencePiece*>(&from));
}
...
void SentencePieceText_SentencePiece::InternalSwap(SentencePieceText_SentencePiece* other) {
  ...
  piece_.Swap(&other->piece_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
              GetArena());
  surface_.Swap(&other->surface_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                GetArena());
...
void SentencePieceText::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
size_t SentencePieceText::ByteSizeLong() const {
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size +=
          1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(this->_internal_text());
    }
...
void NBestSentencePieceText::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
void NBestSentencePieceText::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
::PROTOBUF_NAMESPACE_ID::uint8* NBestSentencePieceText::_InternalSerialize(
  ...
  // repeated .sentencepiece.SentencePieceText nbests = 1;
  for (unsigned int i = 0, n = static_cast<unsigned int>(this->_internal_nbests_size()); i < n;
       i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
